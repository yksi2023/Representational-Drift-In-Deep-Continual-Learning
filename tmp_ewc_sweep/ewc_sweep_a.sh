#!/usr/bin/env bash
#SBATCH --job-name=ewc_sweep_a
#SBATCH --partition=gpu_4090
#SBATCH --gpus=4
#SBATCH --output=logs/%x_%j.out
#
# EWC lambda sweep A (4090): interleaved values from 1e4–1e8
# -----------------------------------------------------------------------------
set -euo pipefail
ulimit -n 65536
...
LAMBDAS=(10000 50000 250000 700000 2500000 7000000 25000000 70000000)
