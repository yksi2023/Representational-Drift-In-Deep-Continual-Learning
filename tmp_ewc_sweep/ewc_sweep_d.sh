#!/usr/bin/env bash
#SBATCH --job-name=ewc_sweep_d
#SBATCH --partition=gpu_5090
#SBATCH --gpus=4
#SBATCH --output=logs/%x_%j.out
#
# EWC lambda sweep D (5090): interleaved values from 1e4–1e8
# -----------------------------------------------------------------------------
set -euo pipefail
ulimit -n 65536
...
LAMBDAS=(30000 150000 600000 2000000 6000000 20000000 60000000 90000000)
