#!/usr/bin/env bash
#SBATCH --job-name=ewc_sweep_c
#SBATCH --partition=gpu_5090
#SBATCH --gpus=4
#SBATCH --output=logs/%x_%j.out
#
# EWC lambda sweep C (5090): interleaved values from 1e4–1e8
# -----------------------------------------------------------------------------
set -euo pipefail
ulimit -n 65536
...
LAMBDAS=(20000 100000 500000 1500000 5000000 15000000 50000000 85000000)
