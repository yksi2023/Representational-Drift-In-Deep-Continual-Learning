...
class IncrementalImageNet1k:
    ...
    Expects the layout produced by ``cnn/process_imagenet.py``::
    ...
    '''
    def __init__(self, root: str = "data/imagenet1k-200-processed",
                 num_classes: int = 200, resize: int = 224):
...
DATASET_CHOICES = ("fashion_mnist", "tiny_imagenet", "cifar100", "imagenet21k_p200", "imagenet1k")
...
def build_dataset(name: str, **kwargs):
    ...
    if name == "imagenet1k":
        return IncrementalImageNet1k(
            root=kwargs.get("root", "data/imagenet1k-200-processed"),
            num_classes=kwargs.get("num_classes", 200),
            resize=kwargs.get("img_size", 224),
        )
